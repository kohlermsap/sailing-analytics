...
public class LoadApi {
  ...
  public static void go(Runnable onLoad, ArrayList<LoadLibrary> loadLibraries) {
    load(onLoad, loadLibraries, null, null);
  }
   ...
   */
  public static void go(Runnable onLoad, ArrayList<LoadLibrary> loadLibraries, Language language) {
    load(onLoad, loadLibraries, language, null);
  }
  ...
  public static void go(Runnable onLoad, LoadLibrary[] loadLibraries) {
    ...
    load(onLoad, loadLibrariesList, null, null);
  }
  ...
  public static void go(Runnable onLoad, LoadLibrary[] loadLibraries, Language language) {
    ArrayList<LoadLibrary> loadLibrariesList = new ArrayList<LoadLibrary>(Arrays.asList(loadLibraries));
    load(onLoad, loadLibrariesList, language, null);
  }
   ...
   */
  public static void go(Runnable onLoad, String otherParams) {
    load(onLoad, null, null, otherParams);
  }
  ...
  public static void go(Runnable onLoad, ArrayList<LoadLibrary> loadLibraries, String otherParams) {
    load(onLoad, loadLibraries, null, otherParams);
  }
  ...
  public static void go(Runnable onLoad, ArrayList<LoadLibrary> loadLibraries, Language language,
      String otherParams) {
    load(onLoad, loadLibraries, language, otherParams);
  }

  private static void load(Runnable onLoad, ArrayList<LoadLibrary> loadLibraries, Language language,
      String otherParams) {

    if (loadLibraries != null) {
        otherParams += "&" + getLibraries(loadLibraries);
    }

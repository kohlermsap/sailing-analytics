...
public class ManeuverMarkersAndLossIndicators {
    ...
    public void getAndShowManeuvers(RegattaAndRaceIdentifier race, Map<String, TimeRange> competitorIdsAsStringsAndTimeRange) {
        sailingService.getManeuvers(race, competitorIdsAsStringsAndTimeRange, new AsyncCallback<Map<String, List<ManeuverDTO>>>() {
            @Override
